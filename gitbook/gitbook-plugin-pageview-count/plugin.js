...
// 配置各网页id
var id_map = new Map();
// https://dl.hycbook.com/chapters/
id_map.set("", "hvxncdad");
// https://dl.hycbook.com/chapters/huggingface基本使用教程.html
id_map.set("huggingface基本使用教程.html", "hvxncdax");
// https://dl.hycbook.com/chapters/dl_in_vision_field.html
id_map.set("dl_in_vision_field.html", "hmexncdak");
// https://dl.hycbook.com/chapters/深度学习核心之优化器.html
id_map.set("深度学习核心之优化器.html", "hmexncdak");
// https://dl.hycbook.com/chapters/深度学习核心之激活函数.html
id_map.set("深度学习核心之激活函数.html", "hxncdaa");
// https://dl.hycbook.com/chapters/图神经网络.html
id_map.set("图神经网络.html", "hxncdaa");
// https://dl.hycbook.com/chapters/目标检测与跟踪算法.html
id_map.set("目标检测与跟踪算法.html", "hvuxncdaf");
// https://dl.hycbook.com/chapters/深度学习模型压缩技术.html
id_map.set("深度学习模型压缩技术.html", "hvuxncdaf");
// https://dl.hycbook.com/chapters/transformer.html
id_map.set("transformer.html", "hrxncdan");
// https://dl.hycbook.com/chapters/图像分类算法.html
id_map.set("图像分类算法.html", "hrxncdan");
// https://dl.hycbook.com/chapters/深度学习核心基础知识点.html
id_map.set("深度学习核心基础知识点.html", "hmxncdao");
// https://dl.hycbook.com/chapters/数据标注工具.html
id_map.set("数据标注工具.html", "hmxncdao");
// https://dl.hycbook.com/chapters/nlp关键词和摘要提取技术整理.html
id_map.set("nlp关键词和摘要提取技术整理.html", "hexncdap");
...
id_map.set("pytorch学习.html", "hxncdac");
// https://dl.hycbook.com/chapters/深度学习核心之损失函数.html
id_map.set("深度学习核心之损失函数.html", "hxncdac");
// https://dl.hycbook.com/chapters/图像分割算法.html
id_map.set("图像分割算法.html", "heexncdfd");
// https://dl.hycbook.com/chapters/LLM模型部署调试推理.html
id_map.set("LLM模型部署调试推理.html", "heexncdfd");
// ===========================================
